...
(function (factory) {
  ...
  $.fn.tilt = function (options) {
    /**
         ...
         */
    const requestTick = function requestTick() {
    ...
    /**
         ...
         */
    const setTransition = function setTransition() {
      const _this2 = this;
    ...
    /**
         ...
         * @returns {{x: *, y: *}}
         */
    const getMousePositions = function getMousePositions(event) {
    ...
    /**
         * Prepare elements
         */
    const prepareGlare = function prepareGlare() {
      const { glarePrerender } = this.settings;
